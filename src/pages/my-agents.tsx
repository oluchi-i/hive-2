        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between mb-8">
          <div>
            ...
            <div className="mt-3 flex flex-wrap gap-2 text-xs">
              <span className="rounded-full bg-emerald-500/10 px-3 py-1 text-emerald-500">Active {activeCount}</span>
              <span className="rounded-full bg-slate-500/10 px-3 py-1 text-slate-500">Idle {idleCount}</span>
            </div>
          </div>
          <button
            ...
            {agents.map((agent) => (
              ...
              >
                ...
                <div className="flex flex-col gap-2 text-xs text-muted-foreground sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <span className="rounded-full border border-border/60 bg-muted/10 px-2 py-1 text-[11px] uppercase tracking-[0.18em]">
                    {agent.last_active ? timeAgo(agent.last_active) : "Never run"}
                  </span>
                </div>
              </button>
            ))}
